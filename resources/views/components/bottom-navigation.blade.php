<div>
    <div class="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 flex md:top-0 md:h-full md:w-auto md:items-center md:border-r place-content-between flex-col">
        ...
        <div class="flex max-w-2xl mx-auto font-medium md:block items-center align-items-center">
            <a href="{{ route('home') }}" class="inline-flex flex-row items-center justify-center px-5 hover:bg-gray-50 group md:block p-5">
            ...
            <a href="{{ route('search.index') }}" class="inline-flex flex-row items-center justify-center px-5 hover:bg-gray-50 group md:block p-5">
            ...
            <suspense>
                <post-form-component>
                    <button type="button" class="inline-flex flex-row items-center justify-center px-5 hover:bg-gray-50 group md:block p-5">
            ...
            <a href="{{route('activity.index')}}" class="inline-flex flex-row items-center justify-center px-5 hover:bg-gray-50 group md:block p-5">
        ...
        <div class="hidden md:block p-5">menu</div>
    </div>
</div>
